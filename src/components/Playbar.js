                ...
                <div className="flex-1 flex flex-col items-center">
                    ...
                    <div className="mt-2 flex items-center">
                        <button className="w-8 h-8 text-gray-900 hover:text-gray-800 focus:outline-none">
                            <svg viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.44 22.56l-9.547-9.545a1.5 1.5 0 010-2.122l9.546-9.546a1.5 1.5 0 012.122 2.122l-8.486 8.485 8.486 8.485a1.5 1.5 0 01-2.122 2.122z" fill="currentColor"/></svg>
                        </button>
                        ...
                        <button className="w-8 h-8 text-gray-900 hover:text-gray-800 focus:outline-none">
                            <svg viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.56 1.44l9.547 9.545a1.5 1.5 0 010 2.122L8.56 22.653a1.5 1.5 0 11-2.122-2.122l8.486-8.485L6.439 3.56a1.5 1.5 0 112.122-2.122z" fill="currentColor"/></svg>
                        </button>
                    </div>
