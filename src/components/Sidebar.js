        ...
        return (
            <nav className="bg-gray-800 border-gray-900 border-r shadow-lg w-80 px-4 flex flex-col text-gray-200 items-center">
                ...
                <div class="relative flex items-center">
                    ...
                    <svg className="absolute top-0 left-0 ml-2 mt-1 text-gray-400 w-4 h-4" viewBox="0 0 24 24" fill="none" ><path fill-rule="evenodd" clip-rule="evenodd" d="M9.66 3.689c-3.342 0-5.971 2.553-5.971 5.607 0 3.054 2.629 5.607 5.97 5.607 3.342 0 5.971-2.553 5.971-5.607 0-3.054-2.629-5.607-5.97-5.607zM2 9.296C2 5.224 5.473 2 9.66 2c4.185 0 7.659 3.224 7.659 7.296 0 1.801-.68 3.436-1.8 4.7L22 20.13l-1.16 1.226-6.58-6.228a7.895 7.895 0 01-4.6 1.463C5.472 16.592 2 13.37 2 9.296z" fill="currentColor"/></svg>
                </div>
